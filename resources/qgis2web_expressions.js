...
function exp_Communelimitrophe_3rule0_eval_expression(context) {
    // "CCRCA" = 'DIAMNIADIO POLE URBAIN'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('CCRCA')  == 'DIAMNIADIO POLE URBAIN');
    } else {
        return (feature.get('CCRCA')  == 'DIAMNIADIO POLE URBAIN');
    }
}
...
function exp_Communelimitrophe_3rule1_eval_expression(context) {
    // "CCRCA" <> 'DIAMNIADIO POLE URBAIN'
